...
public class TasksFunctionsSQL {
    ...
    public TasksTable cleanTask(TasksTable t){
        ...
        t.repeatFrequency = t.repeatFrequency == null || t.repeatFrequency.isEmpty() ? "-1" : t.repeatFrequency;
...
//    public List<TasksTable> getTasksOfWeek(int year, int week){
//        try {
//            String[] range = Functions.getWeekDateRange(year, week, Locale.FRANCE);
//            return executorService.submit(() -> tasksDAO.getTaskFromWeek(range[0], range[1])).get();
//        } catch (Exception e) {
//            handleException("getWeekTasks", e);
//            return Collections.emptyList();
//        }
//    }
